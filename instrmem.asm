...
//          EOR R9, R3, R4    	; R9 = 12 XOR 7 = 11          		1110 000 0001 0 0011 1001 0000 0000 0100 E0239004 0x4c
//  		ADD R6, R9, #255   	; R6 = 266                    		1110 001 0100 0 1001 0110 0000 1111 1111 E28960FF 0x50
//          STR R6, [R3, #24]  	; mem[12+24] = 266		     		1110 010 1100 0 0011 0110 0000 0001 1000 E5836018 0x54
//          LDRB R2, [R3, #25] ; R10 = mem[12+25] = 1				1110 010 1110 1 0011 0010 0000 0001 1001 E5D32019 0x58
//          B END             	; always taken						1110 1010 0000 0000 0000 0000 0000 0001  EA000001 0x5c
//          ADD R2, R0, #13   	; shouldn't happen					1110 001 0100 0 0000 0010 0000 0000 0001 E280200D 0x60
//          ADD R2, R0, #10		; shouldn't happen					1110 001 0100 0 0000 0010 0000 0000 0001 E280200A 0x64
//  END     STR R2, [R0, #100] 	; mem[100] = 1                  	1110 010 1100 0 0000 0010 0000 0101 0100 E5802064 0x68
